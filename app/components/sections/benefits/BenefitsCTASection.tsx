...
export default function BenefitsCTASection() {
  return (
    <SectionContainer size="xl" className="py-12 sm:py-16 md:py-20 lg:py-24 bg-linear-to-b from-transparent rounded-2xl sm:rounded-3xl to-primary/10">
      <motion.div
        className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 xl:px-0"
        initial="hidden"
        whileInView="visible"
