...
export default function BonusCTASection() {
  return (
    <SectionContainer size="xl" noPaddingY className="py-10 sm:py-12 md:py-14 lg:py-16">
      <motion.div
      ...
      >
        Ready to join the{" "}
        <span className="text-primary tracking-tight">First Team?</span>
      </motion.h2>
      <motion.p
        ...
        variants={dropVariants}
      >
        Applications are processed within 48 hours. Start your journey towards a
        stable career with competitive rewards today.
      </motion.p>
      <motion.div
