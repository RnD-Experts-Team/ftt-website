      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <h1
              className="
                px-[2px]           /* prevents glyph clipping */
                text-[2.1rem]
                sm:text-4xl
                md:text-5xl
                lg:text-6xl
                uppercase
                font-black
                leading-[1.12]     /* safe line-height for mobile */
                tracking-tight
                text-slate-900
                dark:text-white
                mb-6
          ...
          >
            <p className="text-slate-600 dark:text-slate-400 text-base sm:text-lg leading-relaxed">
              Our pay model is performance-based, not tenure-based. That means:
            </p>
            <motion.ul 
              className="space-y-3"
              initial="hidden"
            ...
            >
              <motion.li variants={listItemVariants} className="flex items-start gap-2">
                ...
                <span className="text-sm sm:text-base md:text-lg text-slate-700 dark:text-slate-300">Safer drivers earn more</span>
              </motion.li>
              <motion.li variants={listItemVariants} className="flex items-start gap-2">
                <motion.span 
                  className="material-symbols-outlined text-primary text-lg sm:text-xl mt-0.5 flex-shrink-0"
                  ...
                  viewport={{ once: true }}
                >check_circle</motion.span>
                <span className="text-sm sm:text-base md:text-lg text-slate-700 dark:text-slate-300">Reliable drivers get more hours</span>
              </motion.li>
              <motion.li variants={listItemVariants} className="flex items-start gap-2">
                <motion.span 
                  className="material-symbols-outlined text-primary text-lg sm:text-xl mt-0.5 flex-shrink-0"
                  ...
                  viewport={{ once: true }}
                >check_circle</motion.span>
                <span className="text-sm sm:text-base md:text-lg text-slate-700 dark:text-slate-300">Top performers unlock additional earning opportunities</span>
              </motion.li>
            </motion.ul>
          </motion.div>
        ...
        >
          ...
          />
          <img
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuDLrnpi5yglx_kUf3Gkq90o0tvG7dBZ5GLHgaSL9vBi-8moFPcHlrxziBruKoxm2t_KNkquJQO9UTc3BqmQl5sSZeT9Zm-QUjnsOdFveykMf3ZsODQgAzlDEcnjlKfuUzdq2lkyEHEfPw9RJMZ6pDMqH5yjaAcQ8a_3o-QoOlqNjfr-p75o70Mona9zcy7YGdM6o2tXOqeoBa2QQ9E0oFAu8fi7Lrhb8iYRbME9CUE6TyFGu3qFRuujnwVoKQe_iTeZL8XyTDqmktg"
